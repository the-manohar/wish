...
function Home() {
  const { id } = useParams();
  const [name, setName] = useState(id || null);
  return (
    <>
      <div className="main">
        <div className="first">
      ...
      <div className="last-main">
        ...
        <div className="last-l">
          <a
            href={`whatsapp://send?text=😮 *Surprise* 😮%0A😮 *Surprise* 😮%0A😮 *Surprise* 😮%0A*See This* 🤫🤭%0A‼️👇👇👇👇‼️%0A https://mleo-wish.netlify.app/name/{!name ? "":${name}}`}
          >
            <span>
